...
class DronesControllerTest < ActionController::TestCase
  ...
  test "should create drone" do
    assert_difference('Drone.count') do
      post :create, drone: { droneName: @drone.droneName, droneNumber: @drone.droneNumber, latitude: @drone.latitude, longitude: @drone.longitude }
    end
  ...
  test "should update drone" do
    patch :update, id: @drone, drone: { droneName: @drone.droneName, droneNumber: @drone.droneNumber, latitude: @drone.latitude, longitude: @drone.longitude }
    assert_redirected_to drone_path(assigns(:drone))
  end
